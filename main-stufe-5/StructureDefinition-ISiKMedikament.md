...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKMedikament | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKMedikament |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKMedikament)
...
```json
{
  ...
  "id" : "ISiKMedikament",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKMedikament",
  "version" : "0.1.0",
  "name" : "ISiKMedikament",
  "status" : "active",
  "experimental" : false,
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKMedikament"
          }
        ]
      },
      {
        ...
        "type" : [
          {
            "code" : "Coding",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ISiKASKCoding"
            ]
          }
        ],
        "patternCoding" : {
