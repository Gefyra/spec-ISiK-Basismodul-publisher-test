...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Appointment/f:priority">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ISiKTerminPriorityExtension']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ISiKTerminPriorityExtension': maximum cardinality of 'extension' is 1</sch:assert>
