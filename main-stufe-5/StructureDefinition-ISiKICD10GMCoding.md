...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKICD10GMCoding | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKICD10GMCoding |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKICD10GMCoding)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKICD10GMCoding",
  "version" : "0.1.0",
