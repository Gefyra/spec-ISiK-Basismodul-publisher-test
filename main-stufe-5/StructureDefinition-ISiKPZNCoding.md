...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKPZNCoding | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKPZNCoding |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKPZNCoding)
...
```json
{
  ...
  "id" : "ISiKPZNCoding",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKPZNCoding",
  "version" : "0.1.0",
  "name" : "ISiKPZNCoding",
  "title" : "ISiKPZNCoding",
  "status" : "active",
