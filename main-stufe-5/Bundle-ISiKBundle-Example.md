# Bundle-Beispiel-Blutdruck - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bundle-Beispiel-Blutdruck**

## Example Bundle: Bundle-Beispiel-Blutdruck
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://gefyra.info/training/StructureDefinition/ISiKBerichtBundle"
    ]
  },
  "identifier" : {
    "type" : {
