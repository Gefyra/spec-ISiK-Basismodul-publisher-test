# ExampleISiKMedikationsVerordnung2 - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ExampleISiKMedikationsVerordnung2**

## Example MedicationRequest: ExampleISiKMedikationsVerordnung2
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://gefyra.info/training/StructureDefinition/ISiKMedikationsVerordnung"
    ]
  },
  "extension" : [
    {
