# CapabilityStatement für Rolle "ISiKCapabilityStatementErweiterteStammdatenRolle" - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementErweiterteStammdatenRolle | *Version*:0.1.0 |
...
CapabilityStatement für die Rolle "ISiKCapabilityStatementErweiterteStammdatenRolle". Diese Rolle stellt erweiterte Interaktionen zur Abfrage von Stammdaten bereit. 
 ...
 [Raw OpenAPI-Swagger Definition file](ISiKCapabilityStatementErweiterteStammdatenRolle.openapi.json) | [Download](ISiKCapabilityStatementErweiterteStammdatenRolle.openapi.json) 
...
| | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [Patient](#Patient1-1) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKPatient` |  | **Y** |  |  | name, address, address-city, address-country, address-postalcode, active, telecom |  | `Encounter:patient`,`Encounter:subject` |  |
| [Encounter](#Encounter1-2) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKKontaktGesundheitseinrichtung` |  | **Y** |  |  | location, service-provider | `Encounter:subject`,`Encounter:part-of`,`Encounter:diagnosis`,`Encounter:account` | `Encounter:part-of` |  |
