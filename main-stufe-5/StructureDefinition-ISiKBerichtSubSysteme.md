...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKBerichtSubSysteme | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKBerichtSubSysteme |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKBerichtSubSysteme)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKBerichtSubSysteme",
  "version" : "0.1.0",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKBerichtSubSysteme"
          }
        ]
      },
      {
