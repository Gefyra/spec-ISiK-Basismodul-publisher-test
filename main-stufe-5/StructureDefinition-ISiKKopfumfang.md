...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKKopfumfang | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKKopfumfang)
...
```json
{
  ...
  "id" : "ISiKKopfumfang",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKKopfumfang",
  "version" : "0.1.0",
  "name" : "ISiKKopfumfang",
  "status" : "active",
  "experimental" : false,
