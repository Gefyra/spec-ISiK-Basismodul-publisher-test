...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/CodeSystem/ISiKEntlassformRehaCS | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKEntlassformReha |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/CodeSystem/ISiKEntlassformRehaCS",
  "version" : "0.1.0",
