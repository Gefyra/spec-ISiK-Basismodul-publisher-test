# ISiK CapabilityStatement Metadaten Erzeugen Rolle - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementMetadatenErzeugenRolle | *Version*:0.1.0 |
...
CapabilityStatement für die Rolle "ISiKCapabilityStatementMetadatenErzeugenRolle". Diese Rolle beschreibt verpflichtende Interaktionen zur Erzeugung von Metadaten für Dokumente. 
 ...
 [Raw OpenAPI-Swagger Definition file](ISiKCapabilityStatementMetadatenErzeugenRolle.openapi.json) | [Download](ISiKCapabilityStatementMetadatenErzeugenRolle.openapi.json) 
