# ExtensionISiKRehaEntlassung - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ExtensionISiKRehaEntlassung | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ExtensionISiKRehaEntlassung |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ExtensionISiKRehaEntlassung)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ExtensionISiKRehaEntlassung",
  "version" : "0.1.0",
    ...
    "element" : [
      {
        "id" : "Extension",
        "path" : "Extension",
        "definition" : "Extension zur Dokumentation von Informationen nach §301 (4 und 4a) SGB V, entsprechend dem ärztliche Reha-Entlassungsbericht. Mit dieser Extension können spezifische Entlassungsinformationen im Kontext einer Rehabilitationsmaßnahme angegeben werden. Dies ist besonders relevant für Einrichtungen, die Leistungen im Bereich Rehabilitation erbringen, und unterstützt die strukturierte Kommunikation im Entlassmanagement."
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKEntlassformReha"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKBesondereBehandlungsformReha"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKBehandlungsergebnisReha"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKUnterbrechungReha"
        }
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://gefyra.info/training/StructureDefinition/ExtensionISiKRehaEntlassung"
      },
      {
