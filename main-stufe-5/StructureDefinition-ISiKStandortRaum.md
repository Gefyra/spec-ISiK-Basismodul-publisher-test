...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKStandortRaum | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKStandortRaum)
...
```json
{
  ...
  "id" : "ISiKStandortRaum",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKStandortRaum",
  "version" : "0.1.0",
