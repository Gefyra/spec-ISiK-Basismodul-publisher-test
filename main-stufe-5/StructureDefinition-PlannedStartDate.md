...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/5.0/StructureDefinition/extension-Encounter.plannedStartDate | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:PlannedStartDate |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/PlannedStartDate)
    ...
    "element" : [
      {
        "id" : "Extension",
        "path" : "Extension",
        "definition" : "Diese Extension dient der Erfassung des geplanten Startzeitpunkts (dateTime) eines Encounters, z. B. einer stationären Aufnahme, Operation oder eines Termins. Sie ermöglicht eine strukturierte Terminplanung, erleichtert die Koordination verschiedener Versorgungsprozesse und verbessert die Kommunikation zwischen Systemen und Leistungserbringern."
      },
      {
