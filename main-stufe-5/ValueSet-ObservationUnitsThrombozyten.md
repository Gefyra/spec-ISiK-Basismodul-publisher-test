# ObservationUnitsThrombozyten - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ObservationUnitsThrombozyten | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ObservationUnitsThrombozyten",
  "version" : "0.1.0",
