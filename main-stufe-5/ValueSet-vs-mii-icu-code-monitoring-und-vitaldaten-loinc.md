# VS MII ICU Code Monitoring und Vitaldaten [LOINC] - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/vs-mii-icu-code-monitoring-und-vitaldaten-loinc | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/vs-mii-icu-code-monitoring-und-vitaldaten-loinc",
  "version" : "0.1.0",
