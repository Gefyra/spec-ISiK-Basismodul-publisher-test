# ObservationCodesSerumkreatinin - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ObservationCodesSerumkreatinin | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ObservationCodesSerumkreatinin",
  "version" : "0.1.0",
