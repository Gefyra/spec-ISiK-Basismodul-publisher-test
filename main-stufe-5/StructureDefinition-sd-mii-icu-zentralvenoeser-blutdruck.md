# SD MII ICU Zentralvenoeser Blutdruck - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/sd-mii-icu-zentralvenoeser-blutdruck | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:SD_MII_ICU_Zentralvenoeser_Blutdruck |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/sd-mii-icu-zentralvenoeser-blutdruck)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/sd-mii-icu-zentralvenoeser-blutdruck",
  "version" : "0.1.0",
