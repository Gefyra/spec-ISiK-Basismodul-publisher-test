...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKBinary | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKBinary)
...
```json
{
  ...
  "id" : "ISiKBinary",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKBinary",
  "version" : "0.1.0",
  "name" : "ISiKBinary",
  "title" : "ISiKBinary",
  "status" : "active",
