...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKAlkoholAbusus | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKAlkoholAbusus)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKAlkoholAbusus",
  "version" : "0.1.0",
