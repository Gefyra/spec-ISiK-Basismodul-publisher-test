# Schwangerschaftsstatus Valueset - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/SchwangerschaftsstatusVS | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/SchwangerschaftsstatusVS",
  "version" : "0.1.0",
