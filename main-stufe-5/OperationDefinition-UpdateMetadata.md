...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/OperationDefinition/UpdateMetadata | *Version*:0.1.0 |
...
* **Use**: IN
  ...
  * **Binding**: [CompositionStatus](http://hl7.org/fhir/R4/valueset-composition-status.html)(Required)
