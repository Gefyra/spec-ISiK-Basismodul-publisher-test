# ObservationCodesThrombozyten - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ObservationCodesThrombozyten | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ObservationCodesThrombozyten",
  "version" : "0.1.0",
