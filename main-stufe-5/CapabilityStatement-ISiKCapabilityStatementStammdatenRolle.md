# CapabilityStatement für Rolle "StammdatenRolle" - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementStammdatenRolle | *Version*:0.1.0 |
...
CapabilityStatement für die Rolle "ISiKCapabilityStatementStammdatenRolle". Diese Rolle beschreibt Interaktionen zum Abruf und der Verarbeitung grundlegender Stammdaten. 
 ...
 [Raw OpenAPI-Swagger Definition file](ISiKCapabilityStatementStammdatenRolle.openapi.json) | [Download](ISiKCapabilityStatementStammdatenRolle.openapi.json) 
...
| | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [Patient](#Patient1-1) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKPatient` | **Y** | **Y** |  |  | _id, _tag, _count, _has, identifier, family, given, birthdate, gender |  |  |  |
| [Encounter](#Encounter1-2) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKKontaktGesundheitseinrichtung` | **Y** | **Y** |  |  | _id, _tag, _count, _has, identifier, status, class, type, patient, account, date, date-start, end-date | `Encounter:patient` |  |  |
