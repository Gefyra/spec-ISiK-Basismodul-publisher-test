...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKBerichtBundle | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKBerichtBundle)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKBerichtBundle",
  "version" : "0.1.0",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKBerichtBundle"
          }
        ]
      },
      {
        ...
        "type" : [
          {
            "code" : "Composition",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ISiKBerichtSubSysteme"
            ]
          }
        ]
      },
