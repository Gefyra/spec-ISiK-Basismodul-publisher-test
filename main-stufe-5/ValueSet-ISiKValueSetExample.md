# ISiKValueSetExample - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ISiKValueSetExample**

## ValueSet: ISiKValueSetExample 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/ValueSet/TestValueSet | *Version*:0.1.0 |
| Active as of 2025-11-18 | *Computable Name*:TestValueSet |
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://gefyra.info/training/StructureDefinition/ISiKValueSet"
    ]
  },
