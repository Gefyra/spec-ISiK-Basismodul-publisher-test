...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKKalender | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKKalender)
...
```json
{
  ...
  "id" : "ISiKKalender",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKKalender",
  "version" : "0.1.0",
  "name" : "ISiKKalender",
  "status" : "active",
  "experimental" : false,
