...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKSubscription | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKSubscription |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKSubscription)
...
```json
{
  ...
  "id" : "ISiKSubscription",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKSubscription",
  "version" : "0.1.0",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKSubscriptionTopicVS"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/FhirMimeTypeVS"
        }
      },
      {
