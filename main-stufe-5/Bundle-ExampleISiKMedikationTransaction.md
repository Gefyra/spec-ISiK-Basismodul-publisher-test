# ExampleISiKMedikationTransaction - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ExampleISiKMedikationTransaction**

## Example Bundle: ExampleISiKMedikationTransaction

Profile: [ISiK Medikation Transactionbundle](StructureDefinition-ISiKMedikationTransaction.md)

Bundle ExampleISiKMedikationTransaction of type transaction

-------

Entry 1 - fullUrl = http://my.source.server.local/fhir/MedicationStatement/ExampleISiKMedikationsInformation1
...
```
POST http://my.target.fhir.server.local/MedicationStatement

```

-------

Entry 2 - fullUrl = http://my.source.server.local/fhir/Medication/ExampleISiKMedikament1
...
```
POST http://my.target.fhir.server.local/Medication
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://gefyra.info/training/StructureDefinition/ISiKMedikationTransaction"
    ]
  },
  "type" : "transaction",
  "entry" : [
