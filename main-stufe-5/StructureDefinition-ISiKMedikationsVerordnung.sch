...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKMedicationRequestReplaces']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKMedicationRequestReplaces': maximum cardinality of 'extension' is 1</sch:assert>
