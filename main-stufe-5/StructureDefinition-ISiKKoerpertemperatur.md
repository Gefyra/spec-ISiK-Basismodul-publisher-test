...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKKoerpertemperatur | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKKoerpertemperatur)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKKoerpertemperatur",
  "version" : "0.1.0",
