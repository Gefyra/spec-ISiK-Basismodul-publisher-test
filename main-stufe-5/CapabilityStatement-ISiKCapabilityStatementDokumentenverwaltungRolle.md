# ISiK CapabilityStatement Dokumentenverwaltung Rolle - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementDokumentenverwaltungRolle | *Version*:0.1.0 |
...
CapabilityStatement für die Rolle "ISiKCapabilityStatementDokumentenverwaltungRolle". Diese Rolle beschreibt verpflichtende Interaktionen zur Erstellung, dem Abruf und der Aktualisierung von Dokumenten. 
 ...
 [Raw OpenAPI-Swagger Definition file](ISiKCapabilityStatementDokumentenverwaltungRolle.openapi.json) | [Download](ISiKCapabilityStatementDokumentenverwaltungRolle.openapi.json) 
...
| | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [DocumentReference](#DocumentReference1-1) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKDokumentenMetadaten` | **Y** | **Y** |  | **Y** | _id, _tag, _count, _has, status, identifier, patient, type, category, creation, encounter | `DocumentReference:patient`,`DocumentReference:encounter` |  |  |
| [Binary](#Binary1-2) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKBinary` | **Y** |  |  |  |  |  |  |  |
