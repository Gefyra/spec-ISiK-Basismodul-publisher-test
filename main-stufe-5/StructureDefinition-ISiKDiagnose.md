...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKDiagnose | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKDiagnose)
...
```json
{
  ...
  "id" : "ISiKDiagnose",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKDiagnose",
  "version" : "0.1.0",
  "name" : "ISiKDiagnose",
  "status" : "active",
  "experimental" : false,
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKDiagnose"
          }
        ]
      },
      {
        ...
        "type" : [
          {
            "code" : "Coding",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ISiKICD10GMCoding"
            ]
          }
        ],
        "patternCoding" : {
