...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKGCS | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKGCS)
...
```json
{
  ...
  "id" : "ISiKGCS",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKGCS",
  "version" : "0.1.0",
  "name" : "ISiKGCS",
  "status" : "active",
  "experimental" : false,
