# ISiKKoerperkerntemperatur - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKKoerperkerntemperatur | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKKoerperkerntemperatur)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKKoerperkerntemperatur",
  "version" : "0.1.0",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://gefyra.info/training/StructureDefinition/ISiKKoerpertemperatur",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKKernTempSctVS"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKSpecificKernTempLoincVS"
        }
      }
    ]
  }
