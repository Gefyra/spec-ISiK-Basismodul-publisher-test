...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKAcceptedRisk']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKAcceptedRisk': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKMedikationsart']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKMedikationsart': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKSelbstmedikation']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKSelbstmedikation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKBehandlungsziel']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKBehandlungsziel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKMedicationStatementReplaces']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKMedicationStatementReplaces': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
