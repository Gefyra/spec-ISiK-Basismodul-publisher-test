# Schwangerschaft Erwarteter Entbindungstermin Methode - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/SchwangerschaftEtMethodeVS | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/SchwangerschaftEtMethodeVS",
  "version" : "0.1.0",
