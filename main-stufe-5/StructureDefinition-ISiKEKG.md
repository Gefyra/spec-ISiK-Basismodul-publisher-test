...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKEKG | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKEKG)
...
```json
{
  ...
  "id" : "ISiKEKG",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKEKG",
  "version" : "0.1.0",
  "name" : "ISiKEKG",
  "status" : "active",
  "experimental" : false,
