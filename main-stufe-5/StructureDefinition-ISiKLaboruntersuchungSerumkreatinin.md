# ISiKLaboruntersuchungSerumkreatinin - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKLaboruntersuchungSerumkreatinin | *Version*:0.1.0 |
...
* CapabilityStatements using this Profile: [ISiK CapabilityStatement Labor Minimal Rolle](CapabilityStatement-ISiKCapabilityStatementLaborMinimalRolle.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKLaboruntersuchungSerumkreatinin)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKLaboruntersuchungSerumkreatinin",
  "version" : "0.1.0",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://gefyra.info/training/StructureDefinition/ISiKLaboruntersuchung",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ObservationCodesSerumkreatinin"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ObservationUnitsSerumkreatinin"
        }
      },
      {
