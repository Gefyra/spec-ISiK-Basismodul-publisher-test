...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKHerzfrequenz | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKHerzfrequenz)
...
```json
{
  ...
  "id" : "ISiKHerzfrequenz",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKHerzfrequenz",
  "version" : "0.1.0",
