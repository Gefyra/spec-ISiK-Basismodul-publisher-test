...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKAngehoeriger | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKAngehoeriger)
...
```json
{
  ...
  "id" : "ISiKAngehoeriger",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKAngehoeriger",
  "version" : "0.1.0",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKAngehoeriger"
          }
        ]
      },
      {
