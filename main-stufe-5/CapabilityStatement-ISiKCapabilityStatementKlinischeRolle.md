# CapabilityStatement für Rolle "ISiKCapabilityStatementKlinischeRolle" - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementKlinischeRolle | *Version*:0.1.0 |
...
CapabilityStatement für die Rolle "ISiKCapabilityStatementKlinischeRolle". Diese Rolle beschreibt verpflichtende Interaktionen zum Abruf und der Verarbeitung von ISiKProzeduren und ISiKDiagnosen. 
 ...
 [Raw OpenAPI-Swagger Definition file](ISiKCapabilityStatementKlinischeRolle.openapi.json) | [Download](ISiKCapabilityStatementKlinischeRolle.openapi.json) 
...
| | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [Procedure](#Procedure1-1) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKProzedur` | **Y** | **Y** |  |  | _id, _tag, _count, _has, status, category, code, patient, subject, encounter, date | `Procedure:patient`,`Procedure:subject`,`Procedure:encounter` | `Encounter:diagnosis` |  |
| [Condition](#Condition1-2) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKDiagnose` | **Y** | **Y** |  |  | _id, _tag, _count, _has, clinical-status, patient, subject, encounter, recorded-date, related, category | `Condition:patient`,`Condition:subject`,`Condition:encounter` | `Encounter:diagnosis` |  |
