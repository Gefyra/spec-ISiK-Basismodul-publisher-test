# ExampleISiKMedikationsListeParkinson - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ExampleISiKMedikationsListeParkinson**

## Example List: ExampleISiKMedikationsListeParkinson
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://gefyra.info/training/StructureDefinition/ISiKMedikationsListe"
    ]
  },
  "status" : "current",
  "mode" : "working",
