# ISiK Specific Generische Koerpertemperatur LOINC Konzepte - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ISiKSpecificGenericTempLoincVS | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ISiKSpecificGenericTempLoincVS",
  "version" : "0.1.0",
