...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKStandort | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKStandort)
...
```json
{
  ...
  "id" : "ISiKStandort",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKStandort",
  "version" : "0.1.0",
  "name" : "ISiKStandort",
  "status" : "active",
  "experimental" : false,
