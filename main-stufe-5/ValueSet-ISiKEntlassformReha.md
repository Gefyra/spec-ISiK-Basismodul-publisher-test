...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ISiKEntlassformReha | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKEntlassformRehaVS |
...
* Include all codes defined in [`http://gefyra.info/training/CodeSystem/ISiKEntlassformRehaCS`](CodeSystem-ISiKEntlassformRehaCS.md)version 📦0.1.0
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ISiKEntlassformReha",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "http://gefyra.info/training/CodeSystem/ISiKEntlassformRehaCS"
      }
    ]
  }
}
