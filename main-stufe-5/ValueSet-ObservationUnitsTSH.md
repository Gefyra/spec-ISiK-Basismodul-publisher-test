...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ObservationUnitsTSH | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ObservationUnitsTSH",
  "version" : "0.1.0",
