# Current Smoking Status - IPS - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/current-smoking-status-uv-ips | *Version*:0.1.0 |
| Active as of 2025-11-18 | *Computable Name*:CurrentSmokingStatusUvIps |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/current-smoking-status-uv-ips",
  "identifier" : [
    {
      "use" : "official",
