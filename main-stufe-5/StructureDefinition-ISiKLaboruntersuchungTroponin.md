# ISiKLaboruntersuchungTroponin - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKLaboruntersuchungTroponin | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKLaboruntersuchungTroponin)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKLaboruntersuchungTroponin",
  "version" : "0.1.0",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ObservationCodesTroponin"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ObservationUnitsTroponin"
        }
      },
      {
