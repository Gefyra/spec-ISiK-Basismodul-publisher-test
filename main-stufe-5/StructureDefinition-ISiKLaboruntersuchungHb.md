# ISiKLaboruntersuchungHb - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKLaboruntersuchungHb | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKLaboruntersuchungHb)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKLaboruntersuchungHb",
  "version" : "0.1.0",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ObservationCodesHb"
        }
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/ObservationUnitsHb"
        }
      },
      {
