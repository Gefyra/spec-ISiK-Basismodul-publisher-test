...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKLebensZustand | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKLebensZustand)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKLebensZustand",
  "version" : "0.1.0",
        ...
        "type" : [
          {
            "code" : "Coding",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ISiKLoincCoding"
            ]
          }
        ],
        "mustSupport" : true
