# CapabilityStatement für Rolle "ISiKCapabilityStatementTerminologieRolle" - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementTerminologieRolle | *Version*:0.1.0 |
...
CapabilityStatement für die Rolle "ISiKCapabilityStatementTerminologieRolle". Diese Rolle beschreibt verpflichtende Interaktionen zum Abruf und der Verarbeitung von Terminologie-Ressourcen. 
 ...
 [Raw OpenAPI-Swagger Definition file](ISiKCapabilityStatementTerminologieRolle.openapi.json) | [Download](ISiKCapabilityStatementTerminologieRolle.openapi.json) 
...
| | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [CodeSystem](#CodeSystem1-1) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKCodeSystem` | y? | y? |  |  | _id, _tag, _count, _has, url |  |  |  |
| [ValueSet](#ValueSet1-2) | Supported Profiles  `https://gematik.de/fhir/isik/StructureDefinition/ISiKValueSet` | **Y** | **Y** |  |  | _id, _tag, _count, _has, url, name, status, version, context-type-value |  |  |  |
