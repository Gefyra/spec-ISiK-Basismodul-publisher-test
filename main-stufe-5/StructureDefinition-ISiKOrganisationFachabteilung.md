# ISiKOrganisationFachabteilung - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKOrganisationFachabteilung | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKOrganisationFachabteilung)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKOrganisationFachabteilung",
  "version" : "0.1.0",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKOrganisationFachabteilung"
          }
        ],
        "mustSupport" : true
      },
