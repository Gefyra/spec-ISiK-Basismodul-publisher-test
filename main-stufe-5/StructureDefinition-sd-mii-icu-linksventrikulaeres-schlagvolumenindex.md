# SD MII ICU Linksventrikulaeres Schlagvolumenindex - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/sd-mii-icu-linksventrikulaeres-schlagvolumenindex | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:SD_MII_ICU_Linksventrikulaeres_Schlagvolumenindex |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/sd-mii-icu-linksventrikulaeres-schlagvolumenindex)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/sd-mii-icu-linksventrikulaeres-schlagvolumenindex",
  "version" : "0.1.0",
