...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKOrganisation | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKOrganisation)
...
```json
{
  ...
  "id" : "ISiKOrganisation",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKOrganisation",
  "version" : "0.1.0",
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKOrganisation"
          }
        ],
        "mustSupport" : true
      },
