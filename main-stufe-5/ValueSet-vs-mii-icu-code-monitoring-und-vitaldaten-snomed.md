# VS MII ICU Code Monitoring und Vitaldaten [sct] - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/vs-mii-icu-code-monitoring-und-vitaldaten-snomed | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/vs-mii-icu-code-monitoring-und-vitaldaten-snomed",
  "version" : "0.1.0",
