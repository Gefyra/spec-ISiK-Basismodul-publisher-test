...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKValueSet | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKValueSet)
...
```json
{
  ...
  "id" : "ISiKValueSet",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKValueSet",
  "version" : "0.1.0",
  "name" : "ISiKValueSet",
  "status" : "active",
  "experimental" : false,
