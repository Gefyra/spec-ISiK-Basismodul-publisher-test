...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKProzedur | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKProzedur)
...
```json
{
  ...
  "id" : "ISiKProzedur",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKProzedur",
  "version" : "0.1.0",
  "name" : "ISiKProzedur",
  "status" : "active",
  "experimental" : false,
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKProzedur"
          },
          {
            "key" : "proc-ISiK-2",
            "severity" : "error",
