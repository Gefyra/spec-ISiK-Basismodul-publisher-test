...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKAMTSBewertung | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKAMTSBewertung |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKAMTSBewertung)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKAMTSBewertung",
  "version" : "0.1.0",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ExtensionISiKAcceptedRisk"
            ]
          }
        ],
        "mustSupport" : true
