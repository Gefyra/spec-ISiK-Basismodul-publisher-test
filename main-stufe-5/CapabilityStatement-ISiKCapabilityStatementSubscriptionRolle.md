# CapabilityStatement für Rolle "Subscription" - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementSubscriptionRolle | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKCapabilityStatementSubscriptionRolle |
...
CapabilityStatement für die Rolle "ISiKCapabilityStatementSubscriptionRolle". Diese Rolle beschreibt die Fähigkeiten eines Systems zur Registrierung, Verwaltung und Verarbeitung von FHIR Subscriptions auf Basis themenbasierter Benachrichtigungen nach dem R5-Modell unter Verwendung der Subscriptions-Backport-Mechanismen in FHIR R4. 
 ...
 [Raw OpenAPI-Swagger Definition file](ISiKCapabilityStatementSubscriptionRolle.openapi.json) | [Download](ISiKCapabilityStatementSubscriptionRolle.openapi.json) 
      ...
      "resource" : [
        {
          ...
          "type" : "Subscription",
          "supportedProfile" : [
            "http://gefyra.info/training/StructureDefinition/ISiKSubscription"
          ],
          "interaction" : [
            {
              "extension" : [
        ...
        },
        {
          ...
          "type" : "Bundle",
          "supportedProfile" : [
            "http://gefyra.info/training/StructureDefinition/BackportSubscriptionNotificationR4Fixed"
          ]
        }
      ]
    }
