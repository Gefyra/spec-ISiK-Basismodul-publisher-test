# SD MII ICU Ideales Koerpergewicht - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/sd-mii-icu-ideales-koerpergewicht | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/sd-mii-icu-ideales-koerpergewicht)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/sd-mii-icu-ideales-koerpergewicht",
  "version" : "0.1.0",
