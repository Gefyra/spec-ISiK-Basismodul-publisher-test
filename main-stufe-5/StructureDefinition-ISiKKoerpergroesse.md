...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKKoerpergroesse | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKKoerpergroesse)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKKoerpergroesse",
  "version" : "0.1.0",
