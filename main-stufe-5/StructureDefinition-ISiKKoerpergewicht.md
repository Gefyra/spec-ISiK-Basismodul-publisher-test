...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKKoerpergewicht | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKKoerpergewicht)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKKoerpergewicht",
  "version" : "0.1.0",
