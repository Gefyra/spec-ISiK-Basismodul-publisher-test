# ISiKAllergieUnvertraeglichkeit - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKAllergieUnvertraeglichkeit | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKAllergieUnvertraeglichkeit)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKAllergieUnvertraeglichkeit",
  "version" : "0.1.0",
