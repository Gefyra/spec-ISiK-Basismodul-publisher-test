...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKCodeSystem | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKCodeSystem)
...
```json
{
  ...
  "id" : "ISiKCodeSystem",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKCodeSystem",
  "version" : "0.1.0",
  "name" : "ISiKCodeSystem",
  "status" : "active",
  "experimental" : false,
