...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKAbrechnungsfall | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKAbrechnungsfall)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKAbrechnungsfall",
  "version" : "0.1.0",
