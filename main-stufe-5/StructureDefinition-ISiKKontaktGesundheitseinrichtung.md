# ISiKKontaktGesundheitseinrichtung - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKKontaktGesundheitseinrichtung | *Version*:0.1.0 |
...
* Derived from this Profile: [ISiKTerminKontaktMitGesundheitseinrichtung](StructureDefinition-ISiKTerminKontaktMitGesundheitseinrichtung.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKKontaktGesundheitseinrichtung)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKKontaktGesundheitseinrichtung",
  "version" : "0.1.0",
  ...
  "differential" : {
    "element" : [
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKKontaktGesundheitseinrichtung"
          },
          {
            "key" : "ISiK-enc-2",
            "severity" : "error",
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ExtensionISiKRehaEntlassung"
            ]
          }
        ],
        "mustSupport" : true
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "valueSet" : "http://gefyra.info/training/ValueSet/ISiKLocationPhysicalType"
        }
      },
      {
