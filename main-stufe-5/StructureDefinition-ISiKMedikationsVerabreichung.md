# ISiKMedikationsVerabreichung - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKMedikationsVerabreichung | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKMedikationsVerabreichung |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKMedikationsVerabreichung)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKMedikationsVerabreichung",
  "version" : "0.1.0",
    ...
    "element" : [
        ...
        "type" : [
          {
            "code" : "Coding",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ISiKPZNCoding"
            ]
          }
        ],
        "patternCoding" : {
        ...
        "type" : [
          {
            "code" : "Coding",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ISiKATCCoding"
            ]
          }
        ],
        "patternCoding" : {
        ...
        "type" : [
          {
            "code" : "Coding",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/ISiKSnomedCTCoding"
            ]
          }
        ],
        "patternCoding" : {
      ...
      },
      {
        ...
        "type" : [
          {
            "code" : "Coding",
            "profile" : ["http://gefyra.info/training/StructureDefinition/ISiKCoding"]
          }
        ],
        "patternCoding" : {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://gefyra.info/training/ValueSet/SctRouteOfAdministration"
        }
      },
      {
        ...
        "type" : [
          {
            "code" : "Quantity",
            "profile" : [
              "http://gefyra.info/training/StructureDefinition/MedicationQuantity"
            ]
          }
        ],
        "mustSupport" : true
