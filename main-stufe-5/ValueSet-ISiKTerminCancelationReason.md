# ISiKTerminCancelationReason - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ISiKTerminCancelationReason | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ISiKTerminCancelationReason",
  "version" : "0.1.0",
