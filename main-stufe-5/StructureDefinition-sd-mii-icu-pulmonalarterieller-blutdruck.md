# SD MII ICU Pulmonalarterieller Blutdruck - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/sd-mii-icu-pulmonalarterieller-blutdruck | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:SD_MII_ICU_Pulmonalarterieller_Blutdruck |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/sd-mii-icu-pulmonalarterieller-blutdruck)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/sd-mii-icu-pulmonalarterieller-blutdruck",
  "version" : "0.1.0",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://gefyra.info/training/StructureDefinition/sd-mii-icu-sonstige-pulsatile-druecke-generisch",
