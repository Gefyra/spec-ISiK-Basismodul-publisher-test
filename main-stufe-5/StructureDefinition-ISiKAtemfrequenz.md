...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKAtemfrequenz | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKAtemfrequenz)
...
```json
{
  ...
  "id" : "ISiKAtemfrequenz",
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKAtemfrequenz",
  "version" : "0.1.0",
