# SD MII ICU Sonstige pulsatile Druecke Generisch - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/sd-mii-icu-sonstige-pulsatile-druecke-generisch | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:SD_MII_ICU_Sonstige_Pulsatile_Druecke_Generisch |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/sd-mii-icu-sonstige-pulsatile-druecke-generisch)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/sd-mii-icu-sonstige-pulsatile-druecke-generisch",
  "version" : "0.1.0",
    ...
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          ...
          "valueSet" : "http://gefyra.info/training/ValueSet/vs-mii-icu-bodysite-observation-blutdruck"
        }
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "valueSet" : "http://gefyra.info/training/ValueSet/vs-mii-icu-method-observation-blutdruck"
        }
      },
      {
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/sd-mii-icu-sonstige-pulsatile-druecke-generisch"
          }
        ],
        "mustSupport" : true
      },
