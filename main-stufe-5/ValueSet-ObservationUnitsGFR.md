...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/ValueSet/ObservationUnitsGFR | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/ValueSet/ObservationUnitsGFR",
  "version" : "0.1.0",
