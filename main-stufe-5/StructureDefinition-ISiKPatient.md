...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/ISiKPatient | *Version*:0.1.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ISiKPatient)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/ISiKPatient",
  "version" : "0.1.0",
  "name" : "ISiKPatient",
  "status" : "active",
  "experimental" : false,
        ...
        "constraint" : [
          {
            ...
            "source" : "http://gefyra.info/training/StructureDefinition/ISiKPatient"
          }
        ]
      },
      {
