# ISiKBehandlungsergebnisReha - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/CodeSystem/ISiKBehandlungsergebnisRehaCS | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ISiKBehandlungsergebnisReha |
...
```json
{
  ...
  "url" : "http://gefyra.info/training/CodeSystem/ISiKBehandlungsergebnisRehaCS",
  "version" : "0.1.0",
