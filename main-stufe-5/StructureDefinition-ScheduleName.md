...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/5.0/StructureDefinition/extension-Schedule.name | *Version*:0.1.0 |
| Active as of 2025-10-23 | *Computable Name*:ScheduleName |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/ScheduleName)
