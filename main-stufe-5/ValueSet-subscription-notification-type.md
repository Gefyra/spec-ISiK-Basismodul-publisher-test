# SubscriptionNotificationType - v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.org/fhir/ValueSet/subscription-notification-type | *Version*:0.1.0 | |
...
* Include all codes defined in [`http://hl7.org/fhir/subscription-notification-type`](CodeSystem-subscription-notification-type.md)version 📦0.1.0
