# R4 Backported R5 SubscriptionStatus - v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://gefyra.info/training/StructureDefinition/BackportSubscriptionStatusR4Fixed | *Version*:0.1.0 |
...
* Derived from this Profile: [ISiK Subscription Status](StructureDefinition-ISiKSubscriptionStatus.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/info.gefyra.training|current/StructureDefinition/BackportSubscriptionStatusR4Fixed)
...
```json
{
  ...
  "url" : "http://gefyra.info/training/StructureDefinition/BackportSubscriptionStatusR4Fixed",
  "version" : "0.1.0",
