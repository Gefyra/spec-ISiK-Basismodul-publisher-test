...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ISiKKontaktGesundheitseinrichtung
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:hospitalization/f:dischargeDisposition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKRehaEntlassung']) &lt;= 1">extension with URL = 'http://gefyra.info/training/StructureDefinition/ExtensionISiKRehaEntlassung': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
